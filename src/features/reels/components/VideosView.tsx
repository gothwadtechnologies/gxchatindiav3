  ...
  return (
    <div className="flex-1 overflow-y-auto no-scrollbar pb-10 px-4 pt-4">
      <div className="flex flex-col gap-6">
        {[1, 2, 3].map((video) => (
          <div key={video} className="bg-white rounded-3xl overflow-hidden shadow-sm border border-zinc-100">
            ...
            <div className="p-4">
              <div className="flex items-start justify-between gap-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h4 className="text-sm font-bold text-zinc-900 leading-tight">Amazing Travel Vlog: Exploring the Unknown {video}</h4>
                    <p className="text-[10px] text-zinc-400 font-bold uppercase tracking-widest mt-1">User {video} • 1.2M views • 2 days ago</p>
                  </div>
                </div>
              ...
              <div className="flex items-center gap-6 mt-4 pt-4 border-t border-zinc-50">
